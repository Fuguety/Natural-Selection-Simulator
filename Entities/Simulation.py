import Helpers.Persistency as Persistency
...
class Simulation:
    ...
    def __init__(self, entity_quantity_herbivor, entity_quantity_carnivor, food_quantity):
    ...
    def startRound(self, entity_quantity_herbivor, entity_quantity_carnivor,food_quantity, restart = True):
        ...
        # creates entities with atributes
        for i in range(1, entity_quantity_herbivor + 1):
            ...
            self.herbivor_id_matrix[new_id_position[0]][new_id_position[1]].append(i)
        ...
        for id, entity in enumerate(self.entity_list_herbivor):
            ...
            if entity.alive:
                ...
                if (2 < position[0] < configuration.x) and (0 < position[1] < configuration.y) :
                    ...
                    return_type = entity.move(self.global_food[entity.matrixPosition[0]][entity.matrixPosition[1]])
